        ...
        <div className="col">
          <section>
            ...
            <div className="footer-pay">
              {["paypal", "master-card", "visa", "yandex", "webmoney", "qiwi"].map(
                (option, i) => <div key={i} className={"footer-pay-systems footer-pay-systems-" + option} />
              )}
            </div>
          </section>
          <section>
            <div className="footer-copyright">2009-2022 © BosaNoga.ru — модный интернет-магазин обуви и аксессуаров.
